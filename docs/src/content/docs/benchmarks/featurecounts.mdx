...
Benchmarks were run on AWS cloud infrastructure on 2026-03-07.
...
| ------------------------------- | --------: | -------: | -------: |
| Rsubread featureCounts          |    2m 50s |      56s | 214.1 MB |
| RustQC (all tools, single pass) |   18m 52s |  18m 52s |  13.8 GB |

RustQC's single pass includes featureCounts-compatible counting alongside
dupRadar duplication analysis, all 7 RSeQC tools, TIN, preseq, samtools
