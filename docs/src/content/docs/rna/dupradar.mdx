...
| dupRadar (R) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/dupRadar/duprateExpDens.png`} alt="dupRadar (R) density scatter plot" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/RustQC/GM12878_REP1.markdup.sorted_duprateExpDens.png`} alt="RustQC density scatter plot" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |
...
| dupRadar (R) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/dupRadar/duprateExpBoxplot.png`} alt="dupRadar (R) duplication rate boxplot" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/RustQC/GM12878_REP1.markdup.sorted_duprateExpBoxplot.png`} alt="RustQC duplication rate boxplot" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |
...
| dupRadar (R) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/dupRadar/expressionHist.png`} alt="dupRadar (R) expression histogram" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/RustQC/GM12878_REP1.markdup.sorted_expressionHist.png`} alt="RustQC expression histogram" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |
