...
| RSeQC | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/rseqc/read_duplication/GM12878_REP1.DupRate_plot.png`} alt="RSeQC read duplication plot" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/rseqc/read_duplication/GM12878_REP1.markdup.sorted.DupRate_plot.png`} alt="RustQC read duplication plot" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |
...
| RSeQC | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/rseqc/inner_distance/inner_distance.inner_distance_plot.png`} alt="RSeQC inner distance plot" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/rseqc/inner_distance/GM12878_REP1.markdup.sorted.inner_distance_plot.png`} alt="RustQC inner distance plot" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |
