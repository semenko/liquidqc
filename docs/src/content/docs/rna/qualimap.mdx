...
|:---:|:---:|
| <img src={`${base}benchmarks/large/qualimap/Qualimap/Coverage Profile Along Genes (Total).png`} alt="Qualimap coverage profile (total)" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/qualimap/RustQC/Coverage Profile Along Genes (Total).png`} alt="RustQC coverage profile (total)" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |

#### Coverage Profile Along Genes (High)

| Qualimap (Java) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/qualimap/Qualimap/Coverage Profile Along Genes (High).png`} alt="Qualimap coverage profile (high)" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/qualimap/RustQC/Coverage Profile Along Genes (High).png`} alt="RustQC coverage profile (high)" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |

#### Coverage Profile Along Genes (Low)

| Qualimap (Java) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/qualimap/Qualimap/Coverage Profile Along Genes (Low).png`} alt="Qualimap coverage profile (low)" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/qualimap/RustQC/Coverage Profile Along Genes (Low).png`} alt="RustQC coverage profile (low)" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |
...
| Qualimap (Java) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/qualimap/Qualimap/Reads Genomic Origin.png`} alt="Qualimap reads genomic origin" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/qualimap/RustQC/Reads Genomic Origin.png`} alt="RustQC reads genomic origin" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |

#### Junction Analysis

| Qualimap (Java) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/qualimap/Qualimap/Junction Analysis.png`} alt="Qualimap junction analysis" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/qualimap/RustQC/Junction Analysis.png`} alt="RustQC junction analysis" width="100%" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |
