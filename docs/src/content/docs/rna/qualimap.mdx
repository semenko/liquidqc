  ...
  <figure style={{ margin: 0, textAlign: "center" }}>
    ...
    >
      <img
        ...
        alt="Qualimap coverage profile (total)"
  ...
  <figure style={{ margin: 0, textAlign: "center" }}>
    ...
    >
      <img
        ...
        alt="RustQC coverage profile (total)"
        style={{ width: "100%", borderRadius: "8px" }}
      />
    </div>
...
>
  <figure style={{ margin: 0, textAlign: "center" }}>
    ...
    >
      <img
        src={`${base}benchmarks/large/qualimap/Qualimap/Coverage Profile Along Genes (High).png`}
        alt="Qualimap coverage profile (high)"
        style={{ width: "100%", borderRadius: "8px" }}
      />
    </div>
    <figcaption>Qualimap (Java)</figcaption>
  ...
  <figure style={{ margin: 0, textAlign: "center" }}>
    ...
    >
      <img
        src={`${base}benchmarks/large/qualimap/RustQC/Coverage Profile Along Genes (High).png`}
        alt="RustQC coverage profile (high)"
        style={{ width: "100%", borderRadius: "8px" }}
      />
    </div>
    <figcaption>RustQC</figcaption>
...
>
  <figure style={{ margin: 0, textAlign: "center" }}>
    ...
    >
      <img
        src={`${base}benchmarks/large/qualimap/Qualimap/Coverage Profile Along Genes (Low).png`}
        alt="Qualimap coverage profile (low)"
        style={{ width: "100%", borderRadius: "8px" }}
      />
    </div>
    <figcaption>Qualimap (Java)</figcaption>
  ...
  <figure style={{ margin: 0, textAlign: "center" }}>
    ...
    >
      <img
        src={`${base}benchmarks/large/qualimap/RustQC/Coverage Profile Along Genes (Low).png`}
        alt="RustQC coverage profile (low)"
        style={{ width: "100%", borderRadius: "8px" }}
      />
    </div>
    <figcaption>RustQC</figcaption>
  ...
  <figure style={{ margin: 0, textAlign: "center" }}>
    ...
    >
      <img
        ...
        alt="Qualimap transcript coverage histogram"
        style={{ width: "100%", borderRadius: "8px" }}
      />
    </div>
    <figcaption>Qualimap (Java)</figcaption>
  ...
  <figure style={{ margin: 0, textAlign: "center" }}>
    ...
    >
      <img
        ...
        alt="RustQC transcript coverage histogram"
        style={{ width: "100%", borderRadius: "8px" }}
      />
    </div>
    <figcaption>RustQC</figcaption>
