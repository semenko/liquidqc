# Contributing to dupRust 🧬 🦀

Thanks for your interest in contributing to dupRust! This document covers how to get started.
...
dupRust aims to match R dupRadar output exactly. Float formatting must follow R conventions (15 significant digits, `NA` for NaN, trailing-zero trimming). Integration tests verify this against R reference output with tight tolerances.
...
Please open a [GitHub issue](https://github.com/ewels/dupRust/issues) with:
