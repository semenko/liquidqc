...
fn render_report(data: &ReportData) -> Result<String> {
    ...
    html.push_str(
        "<div class=\"right\"><div class=\"footer\">Generated by \
         <a href=\"https://github.com/semenko/liquidqc\">liquidqc</a>, \
...
fn write_input_section(html: &mut String, data: &ReportData) {
    ...
    html.push_str(
        "<p>Report generated by <a href=\"https://github.com/semenko/liquidqc\">liquidqc</a>, \
         a fork of <a href=\"https://github.com/seqeralabs/RustQC\">RustQC</a>'s Rust \
         performance-rewrite of Qualimap. Results should be identical to Qualimap v2.3 \
         output.</p>\n",
    );
